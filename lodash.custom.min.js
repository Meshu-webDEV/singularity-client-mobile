...
for(;c--;)l[f++]=arguments[++t];return p.apply(o?r:this,l)}if(typeof n!="function")throw new TypeError(rt);var o=t&ot,i=z(n);return u}function J(n,t,r,e,u,o){var i=r&et,c=n.length,f=t.length;if(c!=f&&!(i&&f>c))return false;for(var a=-1,l=true,p=r&ut?[]:nt;++a<c;){var s,h=n[a],v=t[a];if(s!==nt){if(s)continue;l=false;break}if(p){if(!B(t,function(n,t){if(!un(p,t)&&(h===n||u(h,n,r,e,o)))return p.push(t)})){l=false;break}}else if(h!==v&&!u(h,v,r,e,o)){l=false;break}}return l}function M(n,t,r,e,u,o,i){switch(r){case st:
case ht:case _t:return wn(+n,+t);case vt:return n.name==t.name&&n.message==t.message;case dt:case mt:return n==t+""}return false}function U(n,t,r,e,u,o){var i=r&et,c=cr(n),f=c.length;if(f!=cr(t).length&&!i)return false;for(var a=f;a--;){var l=c[a];if(!(i?l in t:Rt.call(t,l)))return false}for(var p=true,s=i;++a<f;){l=c[a];var h,v=n[l],y=t[l];if(!(h===nt?v===y||u(v,y,r,e,o):h)){p=false;break}s||(s="constructor"==l)}if(p&&!s){var g=n.constructor,_=t.constructor;g!=_&&"constructor"in n&&"constructor"in t&&!(typeof g=="function"&&g instanceof g&&typeof _=="function"&&_ instanceof _)&&(p=false);
...
if(typeof t!="function")throw new TypeError(rt);return n=rr(n),function(){return--n>0&&(r=t.apply(this,arguments)),n<=1&&(t=nt),r}}function mn(n){if(typeof n!="function")throw new TypeError(rt);return function(){return!n.apply(this,arguments)}}function On(n){return dn(2,n)}function xn(n){return Bn(n)?Zt(n)?S(n):$(n,Gt(n)):n}function wn(n,t){return n===t||n!==n&&t!==t}function An(n){return null!=n&&Sn(n.length)&&!Tn(n)}function En(n){return n===true||n===false||In(n)&&b(n)==st}function Nn(n){return An(n)&&(Zt(n)||Dn(n)||Tn(n.splice)||Yt(n))?!n.length:!Gt(n).length;
