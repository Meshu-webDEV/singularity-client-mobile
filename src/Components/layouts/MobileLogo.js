...
const MobileLogo = ({
  ...
  if (size === "medium")
    return (
      <div className="relative tracking-in-expand text-primary-light flex flex-col items-center">
        <div className="uppercase tracking-wider text-5xl font-normal text-primary-light">
          singularity
        </div>
        <p className="text-whites-light self-start xs:self-center ml-2 xs:w-8/12 tracking-wider text-sm">
          Organize & Manage tournaments, events, and scrims. Connect your events
          with <span className="font-bold">Twitch</span> &{" "}
